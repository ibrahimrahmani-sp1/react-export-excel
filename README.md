...
```sh
yarn add @ibrahimrahmani/react-export-excel
```

With [npm](https://www.npmjs.com/package/@ibrahimrahmani/react-export-excel):

```sh
npm install @ibrahimrahmani/react-export-excel
```
